...
namespace TheWaningBorder.Presentation
{
    ...
    public sealed class CorpseDissolver : MonoBehaviour
    {
        ...
        public void BeginDeath()
        {
            ...
            // Died inside fog: FogOfWarSystem deactivates out-of-vision views,
            // and StartCoroutine on an inactive GameObject throws — which left
            // the corpse alive forever, because the ECS entity is already gone
            // so fog can never re-show (and re-activate) it. Nobody can watch a
            // dissolve they can't see, so skip straight to the destroy.
            // Same guard as VeilstoneOutcroppingCrystalAnimator.BeginDeath.
