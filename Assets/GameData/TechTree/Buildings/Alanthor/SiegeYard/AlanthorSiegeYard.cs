// File: Assets/GameData/TechTree/Buildings/Alanthor/SiegeYard/AlanthorSiegeYard.cs
// Alanthor Siege Yard — trains siege engines.
//
...
{
    public static class AlanthorSiegeYard
    {
        /// <summary>
