...
// suppressed small nodes, and fires each pocket's collapse exactly once.
...
namespace TheWaningBorder.Bootstrap
{
    public static class BlightPocketBootstrap
    {
        ...
        /// <summary>Spawn the anchor small node and register the pocket.
        /// Returns a fresh buffer handle — the small node spawn is a structural
            ...
            EntityManager em, Entity registry, float2 center, float radius)
        {
            ...
            var smallNode = SmallNode.Create(em, new float3(center.x, y, center.y));
