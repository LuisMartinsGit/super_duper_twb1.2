...
// Location: Assets/GameData/TechTree/Buildings/Age 0/ShrineOfRidan/TempleUpgradeSystem.cs
    ...
    public partial struct TempleUpgradeSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            for (int i = 0; i < completed.Length; i++)
            {
                ...
                // 3. Auto-level every adopted sect's levers to the new temple
                //    level (design 2026-07-05: manual lever buys retired —
                //    the temple IS the sect progression).
                SectAdoption.SyncLeversToTempleLevel(em, faction, nextLevel);

                // 4. Remove TempleUpgradeState — upgrade is complete
                ...
                TheWaningBorder.UI.HUD.PlayerNotificationSystem.Notify(
                    $"Era {nextEra} reached! +{rpGain} Religion Points — adopted sects advanced to Lv {(nextLevel > 3 ? 3 : nextLevel)}");
            }
