    ...
    public partial struct GodsplinterCombatSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (transform, target, godState, damage, faction, entity) in SystemAPI
                ...
                // A corpse does not fire. The marker lands via an
                // EndSimulation ECB, so the health read covers the frame the
                // Godsplinter dies as well — the Veilstinger already guarded
                // this and it was the only curse unit that did.
