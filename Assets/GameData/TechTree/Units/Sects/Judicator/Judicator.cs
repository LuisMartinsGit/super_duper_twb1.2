// File: Assets/GameData/TechTree/Units/Sects/Judicator/Judicator.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class Judicator
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            if (TechCatalog.TryGetUnit("Sect_Judicator", out var def))
            {
            ...
            creator.AddComponent(entity, new UnitAbility { Id = AbilityId.Condemn, CooldownDuration = 20f, CooldownRemaining = 0f, Range = 10f });
