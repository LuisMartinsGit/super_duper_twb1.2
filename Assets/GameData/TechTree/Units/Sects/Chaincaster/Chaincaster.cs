// File: Assets/GameData/TechTree/Units/Sects/Chaincaster/Chaincaster.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class Chaincaster
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            if (TechCatalog.TryGetUnit("Sect_Chaincaster", out var def))
            {
            ...
            creator.AddComponent(entity, new UnitAbility { Id = AbilityId.ChainBind, CooldownDuration = 14f, CooldownRemaining = 0f, Range = 12f });
