// File: Assets/GameData/TechTree/Units/Sects/Nullblade/Nullblade.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class Nullblade
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            creator.AddComponent(entity, new UnitAbility { Id = AbilityId.VoidStrike, CooldownDuration = 20f, CooldownRemaining = 0f, Range = 0f });
