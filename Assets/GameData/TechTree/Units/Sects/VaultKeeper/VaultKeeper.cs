// File: Assets/GameData/TechTree/Units/Sects/VaultKeeper/VaultKeeper.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class VaultKeeper
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            if (TechCatalog.TryGetUnit("Sect_VaultKeeper", out var def))
            {
            ...
            creator.AddComponent(entity, new UnitAbility { Id = AbilityId.Safeguard, CooldownDuration = 18f, CooldownRemaining = 0f, Range = 0f });
