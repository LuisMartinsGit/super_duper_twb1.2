// File: Assets/GameData/TechTree/Units/Alanthor/BatteringRam/BatteringRam.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class BatteringRam
    {
        ...
        private const float DefaultHP = 340f;
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            TechCatalog.TryGetUnit("Alanthor_BatteringRam", out var def);
            if (def != null)
            {
