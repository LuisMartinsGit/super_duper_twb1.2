// File: Assets/GameData/TechTree/Units/Alanthor/Longbowman/Longbowman.cs
...
{
    /// <summary>
    /// Longbowman unit — Alanthor Practice Range Lv 3 tier.
    ///
    ...
    public static class Longbowman
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            if (TechCatalog.TryGetUnit("Alanthor_Longbowman", out var def))
            {
            ...
            float shotSpeed = 0f;
            if (TechCatalog.TryGetUnit("Alanthor_Longbowman", out var pdef))
            {
