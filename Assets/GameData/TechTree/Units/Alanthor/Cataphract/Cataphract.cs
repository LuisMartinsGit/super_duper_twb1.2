// File: Assets/GameData/TechTree/Units/Alanthor/Cataphract/Cataphract.cs
...
namespace TheWaningBorder.Entities
{
    ...
    public static class Cataphract
    {
        ...
        private const float DefaultSpeed = 6.6f;
        private const float DefaultDamage = 18f;
        private const float DefaultLoS = 20f;
        private const float DefaultAttackCooldown = 1.6f;
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            if (TechCatalog.TryGetUnit("Alanthor_Cataphract", out var def))
            {
