// Ballista Emplacement — the PLATFORM half of the pair
...
// moment construction finishes, and raises a replacement 45 s after one is
...
{
    public static class BallistaEmplacement
    {
        public const int PresentationID = 570;
        public const string Id = "Alanthor_BallistaEmplacement";
        /// <summary>The engine this platform mounts.</summary>
        public const string EngineId = "Alanthor_EmplacedBallista";
        /// <summary>Seconds the crew takes to raise a replacement engine.</summary>
        public const float RebuildSeconds = 45f;
        /// <summary>How high above the platform origin the engine stands.</summary>
        public const float MountHeight = 1.1f;
