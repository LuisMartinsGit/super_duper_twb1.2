...
namespace TheWaningBorder.Economy
{
    ...
    public partial struct GathererHutReinforcementSystem : ISystem
    {
        ...
        /// <summary>Reach of the Guild's two defensive bursts. Was borrowed
        /// from the deleted GathererHutIncomeSystem.GatherRadius — the hut no
        /// longer gathers from an area, so the number lives here now. Same
        /// value, so the wards cover exactly the ground they always did.</summary>
        private const float AuraRadius = 19.5f;
