...
namespace TheWaningBorder.AI
{
    ...
    public static class AILogger
    {
        ...
        /// eight brains all issue orders paid for eight disk writes inside one
        /// tick. Same reasoning (and the same 2026-09-03 evidence) as
        ...
        /// <summary>Flush every open log without closing it. Called at match
        /// end so a later crash cannot cost the last couple of seconds — the
        /// part of the log that usually matters most.</summary>
        public static void Flush()
        {
            foreach (var kvp in _writers)
                try { kvp.Value?.Flush(); } catch { }
