...
namespace TheWaningBorder.AI
{
    public static class ThreatMaps
    {
        ...
        /// they live in ThreatMaps.asset now.</summary>
        static ThreatMapsConfig Cfg => ThreatMapsConfig.I;

        /// <summary>cellSize, for callers outside this class.</summary>
        public static float CellSize => Cfg.cellSize;
        ...
        private static void Ensure()
        {
            ...
            _w = math.max(2, (int)math.ceil((2f * _half) / Cfg.cellSize));
        ...
        {
            int cx = (int)math.floor((pos.x + _half) / Cfg.cellSize);
            int cz = (int)math.floor((pos.z + _half) / Cfg.cellSize);
        ...
        public static int MaxInRadius(Faction f, float3 pos, float radius)
        {
            ...
            Ensure();
            var g = _grids[FIdx(f)];
            int r = math.max(0, (int)math.ceil(radius / Cfg.cellSize));
            int cx = (int)math.floor((pos.x + _half) / Cfg.cellSize);
            int cz = (int)math.floor((pos.z + _half) / Cfg.cellSize);
            int best = 0;
