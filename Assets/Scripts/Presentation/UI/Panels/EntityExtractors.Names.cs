...
namespace TheWaningBorder.UI
{
    ...
    public static partial class EntityActionExtractor
    {
        ...
        /// </summary>
        /// <summary>The building's tech-tree id. The tag switch now lives in
        /// Entities.BuildingIds, beside the recipe table it inverts.</summary>
        private static string GetBuildingId(Entity entity, EntityManager em)
            => TheWaningBorder.Entities.BuildingIds.Of(entity, em);
