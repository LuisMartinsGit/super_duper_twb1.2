...
// P_Cadaver_Gem* prefabs. Keeps the asset's serialized field bindings
...
{
    public sealed class CadaverOreNode : OreNode
    {
        public void Shatter()
        {
            if (pieces != null)
            {
                ...
                // scale (3× for iron, 6× for crystals) bloats every collider
