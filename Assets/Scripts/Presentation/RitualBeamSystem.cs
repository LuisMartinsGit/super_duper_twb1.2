...
namespace TheWaningBorder.Presentation
{
    ...
    public class RitualBeamSystem : MonoBehaviour
    {
        ...
        private EntityQuery _pickupAttuningQuery;
        ...
        void Update()
        {
            if (_world == null || !_world.IsCreated)
            {
                ...
                _pickupAttuningQuery = _em.CreateEntityQuery(
            ...
            using var ritualEnts = _ritualQuery.ToEntityArray(Allocator.Temp);
            using var ritualActives = _ritualQuery.ToComponentDataArray<ActiveRitualOnNode>(Allocator.Temp);
            using var ritualTransforms = _ritualQuery.ToComponentDataArray<LocalTransform>(Allocator.Temp);
            ...
            using var pickupEnts = _pickupAttuningQuery.ToEntityArray(Allocator.Temp);
            using var pickupStates = _pickupAttuningQuery.ToComponentDataArray<GlowPickupState>(Allocator.Temp);
            using var pickupTransforms = _pickupAttuningQuery.ToComponentDataArray<LocalTransform>(Allocator.Temp);
