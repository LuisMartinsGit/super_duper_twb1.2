// File: Assets/Scripts/Entities/Units/Scholar.cs
// Alanthor scholar — performs the Purification ritual at active crystal
// nodes. Vulnerable channeling unit (spec §11 item 1). Survival depends on
// escort: defending curse waves spawn during the ritual.
...
namespace TheWaningBorder.Entities
{
    ...
    public static class Scholar
    {
            ...
            where TCreator : struct, IEntityCreator
        {
            ...
            // defending curse-wave Veilstingers are an effective interrupt.
