...
namespace TheWaningBorder.Entities
{
    ...
    public static class Catapult
    {
        ...
        /// <summary>
        /// Create Catapult using EntityManager.
        /// </summary>
        public static Entity Create(EntityManager em, float3 position, Faction faction)
        {
            ...
            if (TechTreeDB.Instance != null && TechTreeDB.Instance.TryGetUnit("Runai_Catapult", out var def))
            {
            ...
            // AOE shooter data — projectiles will splash within this radius
            em.AddComponentData(entity, new AOEShooterData { Radius = DefaultAOERadius });

            return entity;
        }

        /// <summary>
        /// Create Catapult using EntityCommandBuffer for deferred creation.
        /// </summary>
        public static Entity Create(EntityCommandBuffer ecb, float3 position, Faction faction)
        {
            ...
            // AOE shooter data
            ecb.AddComponent(entity, new AOEShooterData { Radius = DefaultAOERadius });
