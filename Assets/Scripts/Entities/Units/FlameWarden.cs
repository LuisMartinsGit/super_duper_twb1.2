...
namespace TheWaningBorder.Entities
{
    ...
    public static class FlameWarden
    {
        ...
        public static Entity Create(EntityManager em, float3 position, Faction faction)
        {
            ...
            em.AddComponentData(entity, new UnitAbility { Id = AbilityId.Sanction, CooldownDuration = 10f, CooldownRemaining = 0f, Range = 6f });
        ...
        public static Entity Create(EntityCommandBuffer ecb, float3 position, Faction faction)
        {
            ...
            ecb.AddComponent(entity, new UnitAbility { Id = AbilityId.Sanction, CooldownDuration = 10f, CooldownRemaining = 0f, Range = 6f });
