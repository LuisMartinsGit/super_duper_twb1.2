// File: Assets/Scripts/Systems/Border/RestorationNodeSystem.cs
// Heals nearby BorderTag entities (buildings and units) within Restoration aura range.
...
namespace TheWaningBorder.Systems.Border
{
    ...
    /// BorderTag entities with Health and heals damaged ones within range.
    /// </summary>
    ...
    public partial struct RestorationNodeSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            _auraQuery = state.GetEntityQuery(
                ComponentType.ReadOnly<RestorationAura>(),
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var auraData = _auraQuery.ToComponentDataArray<RestorationAura>(Allocator.Temp);

            // Process all veilstone entities with Health
