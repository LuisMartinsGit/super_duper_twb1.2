...
namespace TheWaningBorder.Core.Settings
{
    ...
    public static class EquipmentTierConfig
    {
        ...
        /// Veilstone+ grants a second HP layer that absorbs damage before
        /// touching Health.
        /// </summary>
        ...
        /// <summary>Aura radius for Veilstone+ siege units (spec §4.3).</summary>
        public const float SiegeShieldAuraRadius = 8f;

        /// <summary>Bonus shield HP granted by Siege Veilstone aura to each ally in range.</summary>
        public const int SiegeShieldAuraVeilstoneBonus = 30;
